      ...
      <section className="about">
        <div className="about__split">
          ...
          <h1>This is Gifted.</h1>
            ...
            <div>
            <p>GiftCards.com™, the highest-ranking and most-trafficked gift card website on the Internet, is your one-stop shop for gift cards online.</p>
          </div>
        </div>
      ...
      <section className="info">
        ...
        <div className="info__container"> 
           <form action="/">
                            ...
                            <button className="form__container__button__center">Send</button>
                            </div>
                        </form>
        </div>
      </section>
